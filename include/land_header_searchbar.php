<!-- ======= Header/Navbar ======= -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
              <a class="dropdown-item" href="all flats.php">Tous les appartements</a>
              <a class="dropdown-item" href="all lands.php">Tous les Villas</a>
            </div>
          </li>
          <li class="nav-item">
  ...
  <div class="box-collapse">
    <div class="title-box-d">
      <h3 class="title-d">Search annonce</h3>
    </div>
    <span class="close-box-collapse right-boxed ion-ios-close"></span>
    <div class="box-collapse-wrap form">
      <form class="form-a" method="POST" action="search lands.php">
        <div class="row">
          ...
          <div class="col-md-6 mb-2">
            <div class="form-group">
              ...
              <input type="text" name="location" class="form-control form-control-lg form-control-a" placeholder="Localisation" id="city">
            </div>
          </div>
          <div class="col-md-6 mb-2">
            <div class="form-group">
