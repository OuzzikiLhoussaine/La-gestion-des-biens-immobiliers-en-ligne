				...
				<!-- Content Header (Page header) -->
					<div class="content-header">
					  <div class="container-fluid">
						<div class="row mb-2">
						  <div class="col-sm-6">
							<h1 class="m-0 text-dark">TOUS VILLAS</h1>
						  </div><!-- /.col -->
						  <div class="col-sm-6">
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Localisation</th>
                                                <th>Statut</th>
                                                <th>  <a href="add_land.php" class="btn btn-xs btn-primary editbtn"><span class="fa fa-plus"></span>  </a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
											...
											?>
														<tr>
															...
															<td>
															  <a href="update_land.php?l_id=<?php echo $data['id'];?>" class="btn btn-xs btn-success editbtn"><span class="fa fa-edit"></span>  </a>
															  <a href="delete_land.php?l_id=<?php echo $data['id'];?>" class="btn btn-xs btn-danger editbtn"><span class="fa fa-trash"></span>  </a>
															</td>
														</tr>
											<?php 
													}
