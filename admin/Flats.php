				...
				<!-- Content Header (Page header) -->
					<div class="content-header">
					  <div class="container-fluid">
						<div class="row mb-2">
						  <div class="col-sm-6">
							<h1 class="m-0 text-dark">Tous les appartements</h1>
						  </div><!-- /.col -->
						  <div class="col-sm-6">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="mb-0"> Tous les appartements</h3>
                                    ...
                                    <table id="example" class="table table-striped table-bordered second" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Localisation</th>
                                                <th>Statut</th>
                                                <th>  <a href="add_flat.php" class="btn btn-xs btn-primary editbtn"><span class="fa fa-plus"></span>  </a></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
											...
											?>
														<tr>
															...
															<td>															  
															  <a href="update_flat.php?f_id=<?php echo $data['id'];?>" class="btn btn-xs btn-success editbtn"><span class="fa fa-edit"></span>  </a>
															  <a href="delete_flat.php?f_id=<?php echo $data['id'];?>" class="btn btn-xs btn-danger editbtn"><span class="fa fa-trash"></span>  </a>
															</td>
														</tr>
											<?php 
													}
