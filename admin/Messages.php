                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                ...
                                <p> All of the Messages which are Send by the user, which may be for compliant or any Suggestion or client may have query or want to contact are displayed in the following Table.</p>
                            </div>
                            <div class="card-body">
