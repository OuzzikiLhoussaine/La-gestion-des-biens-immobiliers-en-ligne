	...
	<div class="container" style="margin-top: 170px;">
		<div class="login-form col-md-4 offset-md-4 ">
			<div class="jumbotron" style="background-color: lightblue; margin-top: 30%; padding-top: 50px; padding-bottom: 30px;"> 
				...
				<h3 align="center"> Connexion de l'utilisateur </h3> <br/>
				<form method="POST">
					<div class="form-group">
						<label> Email / Nom d'utilisateur </label>
						<input type="email" name="uname" placeholder=" Nom d'utilisateur ou Email " class="form-control" />
					</div>
					<div class="form-group">
						<label> Mot de passe :</label>
						<input type="password" name="pass" placeholder="Votre Mot de passe" class="form-control" />
					</div>
					<div class="form-group">
						<input type="checkbox" name="check" /> &nbsp; Souviens-toi de moi
					</div>
					<div class="form-group">
					<center> <input type="submit" name="submit" value="Login" class="btn btn-lg btn-success"> </center>
				</div>
				<ul type="circle">
					<li><center><a href="#"> Mot de passe oublié? </a> </center>  </li>
					<li><center><a href="#"> Cliquez sur Moi pour vous inscrire. </a> </center> </li>
				</ul>
				</form>
			</div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="credits">
            Designed by <a href="#">  OUZZIKI LHOUSSAINE</a>
          </div>
        </div>
      </div>
    </div>
